...
<html lang="en" data-bs-theme="auto">
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg bg-body-tertiary">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="articles.php" style="color:green; font-weight:bold" > Modifier un article</a>
                    </li>
                </ul>   
            </div>
        ...
        <div class="album py-5 bg-light" class= "mx-auto">
            <div class="container">
